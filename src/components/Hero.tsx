...
const Hero = () => {
  return (
    <section className="relative min-h-[80vh] md:min-h-[70vh] site-gradient pt-16 md:pt-20 overflow-hidden">
      <div className="gradient-container">
        <div className="container mx-auto px-4 pt-12 md:pt-16 text-center relative z-[5]">
          <h1 className="text-3xl md:text-7xl font-bold tracking-tight text-white mb-3 md:mb-4 relative">
          ...
          <div className="flex gap-3 md:gap-4 justify-center relative mb-8 md:mb-0">
